...
public class Enemy4 : Entity
{
    ...
    // public E4_MeleeAttackState MeleeAttackState { get; private set; } // bỏ
    ...
    // [SerializeField] private EnemyMeleeAttackData meleeAttackData; // bỏ
    ...
    // [SerializeField] private Transform attackPoint; // bỏ
    ...
    public override void Start()
    {
        ...
        // MeleeAttackState = new E4_MeleeAttackState(stateMachine, this, "meleeAttack", attackPoint, meleeAttackData, this); // bỏ
    ...
    {
        base.OnDrawGizmos();
        // Bỏ vẽ gizmo liên quan attackPoint
    }
}
