...
public class CombatDumyController : MonoBehaviour
{
    ...
    private void KnockBack()
    {
        ...
        rbAlive.linearVelocity = new Vector2(knockBackSpeed.x * attackDir, knockBackSpeed.y);
    }
    ...
    private void CheckKnockBack()
    {
        ...
        {
            knockBack = false;
            rbAlive.linearVelocity = new Vector2(0,rbAlive.linearVelocity.y);
        }
    }
    ...
    private void Die()
    {
        ...
        rbTop.linearVelocity = new Vector2(deadSpeed.x * attackDir, deadSpeed.y);
        rbBot.linearVelocity = new Vector2(knockBackSpeed.x * playerFacingDir, knockBackSpeed.y);
