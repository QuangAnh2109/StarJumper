...
public class Player : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        Anim.SetFloat("velocityY", _rb.linearVelocity.y);
    ...
    public void SetKnockBack(Vector2 knockBackSpeed)
    {
        ...
        _rb.linearVelocity = _workSpace;
    }

    public void SetVelocityX(float velocityX)
    {
        _workSpace.Set(velocityX, _rb.linearVelocity.y);
        _rb.linearVelocity = _workSpace;
    }
    ...
    {
        _workSpace.Set(_rb.linearVelocity.x, velocityY);
        _rb.linearVelocity = _workSpace;
    }
